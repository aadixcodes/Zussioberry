    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold font-[para] mb-4">News Not Found</h1>
          <Link href="/news" className="text-[#fab604] font-[para] hover:underline">
            Return to News
          </Link>
        </div>
      </div>
    ...
    <section
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-3xl mx-auto">
        <h2 className="text-3xl md:text-6xl font-[heading-1] mb-4">
          Zussioberry Detailed News Page
        </h2>
